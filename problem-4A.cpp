 ...
 * in such a way that each of the two parts weights even number of kilos, at the same time it is
 * not obligatory that the parts are equal. The boys are extremely tired and want to start their
 * meal as soon as possible, that's why you should help them and find out, if they can divide the
